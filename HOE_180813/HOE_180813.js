...
function show_screen_final() {
  ...
  textStyle(BOLD);
  text(text_description_de, windowWidth/3 + 50, windowHeight/2 - windowHeight/4, windowWidth/3 - 100, windowHeight/4 + 25);
  textStyle(NORMAL);
  text(text_description_en, windowWidth/3 + 50, windowHeight/2 + 25, windowWidth/3 - 100, windowHeight/4 + 25); 
