...
// all celestial types - 'none', 'comet', 'eclipse', 'ultra eclipse', 'moon', 'planet', 'orbit', 'meteor shower', 'quasar', 'nova', 'rapture', 'nebula'
...
const allel_celestial_object_types_explosion = [
  [['none'], 10],
  [['ultra eclipse'], 10],
  [['meteor shower'], 15], [['meteor shower', 'ultra eclipse'], 5], [['meteor shower', 'quasar'], 5], [['meteor shower', 'nova'], 5], [['meteor shower', 'rapture'], 5],
  [['quasar'], 15],
  [['nova'], 15],
  [['rapture'], 15]
];
...
const allel_celestial_object_types_empty = [
  [['comet'], 7], [['comet', 'eclipse'], 2], [['comet', 'moon'], 2], [['comet', 'planet'], 2], [['comet', 'orbit'], 2], [['comet', 'meteor shower'], 2],
  [['eclipse'], 7],
  [['ultra eclipse'], 4],
  [['moon'], 15],
  [['planet'], 7],
  [['orbit'], 7],
  [['meteor shower'], 7], [['meteor shower', 'eclipse'], 2], [['meteor shower', 'moon'], 2], [['meteor shower', 'planet'], 2], [['meteor shower', 'orbit'], 2],
  [['quasar'], 7],
  [['nova'], 7],
  [['rapture'], 7],
  [['nebula'], 7]
...
function generate_composition_params(aspect_ratio, frame_type, explosion_type, light_source_type, celestial_object_types) {
